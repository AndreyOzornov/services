...
import mongoauthserver.library.MongoAuthorizationCodeServices;
import mongoauthserver.library.MongoClientDetailsService;
...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        //Keypair is the alias name -> andreykeystore.jks / password / andrey
        KeyPair keyPair = new KeyStoreKeyFactory(new ClassPathResource("andreykeystore.jks"), "137546".toCharArray())
                .getKeyPair("andrey");
